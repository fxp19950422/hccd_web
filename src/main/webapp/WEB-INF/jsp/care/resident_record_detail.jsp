	...
	<div class="profileEditContent">
		<form id="player_form">
            ...
            value="${record.admissionDate}" /></div>
					...
					<sa-panel title="入院情况">
							<pre style="background:white;border-width:0px;">${record.inState}</pre>
						</div>
					</sa-panel>
					<sa-panel title="入院中医诊断">
						<pre style="background:white;border-width:0px">${record.inChiDiagnosis}</pre>
					</sa-panel>
					<sa-panel title="入院西医诊断">
						<pre style="background:white;border-width:0px">${record.inWesDiagnosis}</pre>
					</sa-panel>
					<sa-panel title="诊疗经过">
						<pre style="background:white;border-width:0px">${record.process}</pre>
					</sa-panel>
					<sa-panel title="出院中医诊断">
						<pre style="background:white;border-width:0px">${record.outChiDiagnosis}</pre>
					</sa-panel>
					<sa-panel title="出院西医诊断">
						<pre style="background:white;border-width:0px">${record.outWesDiagnosis}</pre>
					</sa-panel>
					<sa-panel title="出院情况">
						<pre style="background:white;border-width:0px">${record.outState}</pre>
					</sa-panel>
					<sa-panel title="出院医嘱">
