package cn.sportsdata.webapp.youth.web.controller.healthdata.request;

import java.sql.Date;

public class HealthDataReqVO {
	private String id;
	...
	private Date create_time=new Date(new java.util.Date().getTime());
