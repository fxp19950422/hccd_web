 ...
 */
@Component("StartersPlayersSyncACPolicyImpl")
public class StartersPlayersSyncACPolicyImpl extends BaseSyncACPolicyImpl {
    @Override
    public String getReadControlCondition(String tableName, Map acParam){
        ...
        conditionString = tableName +
                ".starters_id in (select id from tactics where org_id in "
